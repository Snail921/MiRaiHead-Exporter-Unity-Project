...
このリポジトリに収録された独自コードとドキュメントは、[MIT License](LICENSE)で提供されます。

Magica Cloth、Magica Cloth 2、利用者がインポートするFBX、テクスチャ、その他の第三者アセットには、それぞれの権利者が定めるライセンスが適用されます。これらの第三者コンテンツに対して、このリポジトリのMIT Licenseが利用許諾を与えるものではありません。
